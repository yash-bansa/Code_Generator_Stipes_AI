...
class DeltaAnalyzerAgent:
    def __init__(self):
        ...
        try:
            ...
            self.specification_prompt = config["specification_prompt"]
            ...
            self.specification_prompt = "Default fallback prompt."
    ...
    def _build_comprehensive_prompt(self, input_data: DeltaAnalyzerInput,
        ...
        prompt = self.specification_prompt.format(user_query=user_query,
                                                   ...
                                                   reason = reason,
                                                   rag_context = file_analysis.get('rag_context', 'No additional context'),
                                                   config = json.dumps(input_data.config, indent=2),
